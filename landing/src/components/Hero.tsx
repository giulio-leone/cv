        ...
        >
          ...
          <div className="mb-6 overflow-hidden">
            <motion.p
              ...
              className="text-white/50 font-serif italic text-lg md:text-xl"
            >
          ...
          <h2 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-light text-text-muted mb-6 md:mb-10 tracking-tight flex flex-col items-center">
            <CinematicText text={content.hero.title} className="font-serif italic text-white" />
            <span className="flex gap-2 sm:gap-3 overflow-hidden mt-1 md:mt-2 font-sans tracking-normal">
              {content.hero.specializations.map((spec, i) => (
                <span key={spec} className="flex gap-2 sm:gap-3">
                  ...
                  <motion.span variants={revealVariant} className="text-white font-serif italic pr-1">{spec}</motion.span>
                </span>
              ))}
            </span>
          </h2>
          ...
          <div className="overflow-hidden mt-2 md:mt-4">
            <motion.p
              variants={revealVariant}
              className="max-w-2xl mx-auto text-white/50 text-base md:text-xl font-light mb-6 md:mb-8 leading-relaxed px-4"
            >
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center overflow-hidden pt-2 md:pt-4 w-full px-6">
            ...
            <motion.div variants={revealVariant} className="z-20 relative">
              <MagneticButton
                ...
                className="!inline-flex items-center justify-center px-10 py-5 border border-white/20 text-white font-semibold rounded-full hover:bg-white/5 transition-colors glass-panel backdrop-blur-md uppercase tracking-wide text-sm gap-3"
              >
