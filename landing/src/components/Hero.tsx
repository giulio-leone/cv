          ...
          <div className="relative grid lg:grid-cols-[1.45fr_0.85fr] gap-8 md:gap-10 items-start">
              ...
              <div className="flex flex-col sm:flex-row gap-3.5 justify-center lg:justify-start overflow-hidden">
                ...
                <motion.div variants={revealVariant} className="z-20 relative">
                  <MagneticButton
                    ...
                    className="!inline-flex items-center justify-center px-8 py-4 border border-foreground/20 text-foreground font-semibold rounded-full hover:bg-foreground/8 transition-colors glass-panel backdrop-blur-md uppercase tracking-[0.14em] text-[11px] gap-3"
                  >
            ...
            <motion.aside variants={revealVariant} className="premium-panel rounded-2xl md:rounded-3xl p-5 md:p-6 text-left">
              ...
              <MagneticButton
                ...
                className="!inline-flex w-full items-center justify-center px-4 py-3 border border-foreground/22 text-foreground font-semibold rounded-xl hover:bg-foreground/8 transition-colors uppercase tracking-[0.14em] text-[10px] gap-2"
              >
